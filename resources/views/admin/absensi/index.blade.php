    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('admin.absensi.export.excel') }}?{{ http_build_query(request()->except('page')) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            placeholder="Nama, email, ID..." class="input-field">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="petugas" value="{{ request('petugas') }}" placeholder="Nama petugas..."
                            class="input-field">
                    </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="relative inline-block" x-data="{ open: false }">
                                        ...
                                        <div x-show="open" x-transition:enter="transition ease-out duration-150"
                                            ...
                                            <!-- View -->
                                            <a href="{{ route('admin.absensi.show', $a->id_absensi) }}"
                                            ...
                                            <a href="{{ route('admin.absensi.edit', $a->id_absensi) }}"
                                                ...
                                                <span class="font-medium">Edit Absensi</span>
                                            </a>
                                            ...
                                            <!-- Delete -->
                                            <form action="{{ route('admin.absensi.destroy', $a->id_absensi) }}"
                                                method="POST"
                                                ...
                                                <button type="submit"
                                                    ...
                                                    <span class="font-medium">Hapus Absensi</span>
                                                </button>
                                            </form>
                                        </div>
                                    </div>
