...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <div class="bg-gradient-to-r from-[#0053C5] to-[#003D91] px-6 py-4">
            <h3 class="text-xl font-bold text-white">Informasi Absensi</h3>
        </div>
        ...
        <div class="p-6 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="text-lg text-gray-800 mt-1">{{ $absensi->peserta->nama_lengkap }}</p>
                </div>
                
                <div>
                    <label class="text-sm font-semibold text-gray-600">Email</label>
                    <p class="text-lg text-gray-800 mt-1">{{ $absensi->peserta->email }}</p>
                </div>
                
                <div>
                    <label class="text-sm font-semibold text-gray-600">Waktu Absen</label>
                    <p class="text-lg text-gray-800 mt-1">{{ \Carbon\Carbon::parse($absensi->waktu_absen)->format('d M Y, H:i') }} WIB</p>
                </div>
            ...
            <div class="flex items-center space-x-4 pt-6 border-t">
                ...
                <form action="{{ route('admin.absensi.destroy', $absensi->id_absensi) }}" method="POST" 
