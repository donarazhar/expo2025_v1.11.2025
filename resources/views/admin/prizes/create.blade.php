...
@section('page-subtitle', 'Tambahkan hadiah baru untuk undian')
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="p-6 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Form Tambah Hadiah</h3>
                <p class="text-sm text-gray-600 mt-1">Lengkapi informasi hadiah yang akan ditambahkan</p>
            </div>

            <form action="{{ route('admin.prizes.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_hadiah" id="nama_hadiah" value="{{ old('nama_hadiah') }}"
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            ...
                            placeholder="Deskripsi detail tentang hadiah...">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="urutan" id="urutan" value="{{ old('urutan', $nextUrutan) }}"
                                min="0"
                        ...
                        <div>
                            ...
                            <select name="kategori" id="kategori"
                                ...
                                <option value="doorprize" {{ old('kategori') == 'doorprize' ? 'selected' : '' }}>Doorprize
                                </option>
