            ...
            <div class="flex flex-col w-full bg-[#0053C5] text-white">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.events.index') }}"
                        class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.events.*') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }} transition-colors"
                        :class="sidebarCollapsed ? 'justify-center' : 'space-x-3'"
                        ...
                        <span class="font-medium" x-show="!sidebarCollapsed">Events</span>
                    </a>

                    <a href="{{ route('admin.faqs.index') }}"
                        class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.faqs.*') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }} transition-colors"
                        :class="sidebarCollapsed ? 'justify-center' : 'space-x-3'"
                        ...
                        <span class="font-medium" x-show="!sidebarCollapsed">FAQs</span>
                    </a>

                    <a href="{{ route('admin.feedbacks.index') }}"
                        class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.feedbacks.*') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }} transition-colors"
                        :class="sidebarCollapsed ? 'justify-center' : 'space-x-3'"
                        :title="sidebarCollapsed ? 'Feedbacks' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z">
                            </path>
                        </svg>
                        <span class="font-medium" x-show="!sidebarCollapsed">Feedbacks</span>
                    </a>

                    <a href="{{ route('admin.galleries.index') }}"
                        class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.galleries.*') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }} transition-colors"
                        :class="sidebarCollapsed ? 'justify-center' : 'space-x-3'"
                        ...
                        <span class="font-medium" x-show="!sidebarCollapsed">Gallery</span>
                    </a>

                    <a href="{{ route('admin.live-streams.index') }}"
                        class="flex items-center px-4 py-3 rounded-lg {{ request()->routeIs('admin.live-streams.*') ? 'bg-white/10 text-white' : 'text-white/70 hover:bg-white/10 hover:text-white' }} transition-colors"
                        :class="sidebarCollapsed ? 'justify-center' : 'space-x-3'"
                        :title="sidebarCollapsed ? 'Live Streaming' : ''">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z">
                            </path>
                        </svg>
                        <span class="font-medium" x-show="!sidebarCollapsed">Live Streaming</span>
                    </a>
