...
<body class="antialiased bg-white">
    ...
    <section id="beranda" class="relative min-h-screen flex items-center overflow-hidden">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('assets/img/hero.png') }}" alt="Hero" class="w-full h-full object-cover">
            ...
            <div class="absolute bottom-20 right-10 w-96 h-96 bg-white/5 rounded-full blur-3xl pulse-slow" style="animation-delay: 1.5s;"></div>
        </div>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 py-32 w-full">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="text-white space-y-8">
                    <div class="fade-in-up">
                        ...
                        <p class="text-lg text-white/80 leading-relaxed max-w-xl">
                            Bergabunglah dalam pameran pendidikan terbesar tahun ini. Temukan inspirasi, inovasi, dan peluang untuk masa depan yang lebih cerah.
                        </p>
                    </div>

                    <div class="flex flex-col sm:flex-row gap-4 fade-in-up delay-300">
                        <a href="#registrasi" class="inline-flex items-center justify-center bg-white text-[#0053C5] px-8 py-4 rounded-full font-bold hover:bg-white/95 transition-all transform hover:scale-105 shadow-2xl group">
                            <span>Daftar Sekarang</span>
                            <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                            </svg>
                        </a>
                        <a href="#tentang" class="inline-flex items-center justify-center bg-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-full font-bold hover:bg-white/20 transition-all border-2 border-white/30">
                    ...
                    <div class="grid grid-cols-3 gap-8 pt-8 fade-in-up delay-500">
                        ...
                        <div>
                            ...
                            <div class="text-sm text-white/70">Exhibitor</div>
                        </div>
                        <div>
                            <div class="text-4xl font-black">3</div>
                            <div class="text-sm text-white/70">Hari Event</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden lg:flex items-center justify-center fade-in-up delay-400">
                    <div class="float">
                        <img src="{{ asset('assets/img/ads.png') }}" alt="Ads" class="w-full h-auto rounded-3xl">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-20 fade-in-up delay-500">
            <div class="flex flex-col items-center gap-2 cursor-pointer" onclick="document.getElementById('tentang').scrollIntoView({behavior: 'smooth'})">
    ...
    <section id="tentang" class="py-24 bg-gradient-to-b from-white to-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16 reveal">
                <div class="inline-block bg-[#0053C5]/10 text-[#0053C5] px-4 py-2 rounded-full mb-4 font-semibold text-sm">TENTANG EVENT</div>
                <h2 class="text-4xl lg:text-6xl font-black text-gray-900 mb-4">
                    Kenapa Harus<br/><span class="gradient-text">Al Azhar Expo?</span>
                </h2>
                <p class="text-gray-600 text-lg max-w-2xl mx-auto">Pameran pendidikan terbesar dengan berbagai program menarik dan bermanfaat</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @foreach(['pro1.png', 'pro2.png', 'pro3.png'] as $img)
                <div class="reveal float">
                    <img src="{{ asset('assets/img/' . $img) }}" alt="Produk" class="w-full h-auto rounded-3xl shadow-lg">
                </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="reveal">
                    <img src="{{ asset('assets/img/tsa.png') }}" alt="Solusi" class="w-full max-w-md mx-auto">
                </div>
                <div class="reveal space-y-6 text-center lg:text-left">
                    <h3 class="text-3xl lg:text-4xl font-extrabold text-[#0053C5]">Solusi Lengkap untuk Kebutuhan Anda</h3>
                    <p class="text-gray-600 text-lg">Mulai dari tabungan hingga solusi digital, hadir dengan berbagai produk yang dirancang untuk memudahkan kehidupan finansial Anda.</p>
                    <button class="px-10 py-4 bg-[#0053C5] text-white font-semibold rounded-full shadow-lg hover:bg-[#0040A0] transition">Lihat Detail</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16 reveal">
                ...
                <p class="text-gray-600 text-lg max-w-2xl mx-auto">4 kategori kegiatan utama yang akan mengisi Al Azhar Expo 2025</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                $kegiatan = [
                    [
                        ...
                        'title' => 'Pameran & Stand',
                        'items' => ['Karya siswa dari berbagai jenjang', 'Display lembaga dan unit Al Azhar', 'Bazar produk unggulan Al Azhar', 'Stand mitra dan sponsor']
                    ],
                    [
                        'icon' => 'M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z',
                        'title' => 'Talkshow Nasional',
                        'items' => ['Pendidikan & Adab: Membentuk generasi berakhlak', 'Ekonomi Keumatan & Wakaf: Pemberdayaan ekonomi', 'Peran Masjid: Masjid sebagai pusat peradaban', 'Digital Expo: Teknologi di era modern']
                    ],
                    [
                        'icon' => 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z',
                        'title' => 'Lomba & Festival',
                        'items' => ['Lomba Robotik & Coding', 'Islamic Fashion Show', 'Pentas Seni & Performance', 'Rampak Gendang Tradisional']
                    ],
                    [
                        'icon' => 'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z',
                        'title' => 'Kegiatan Khusus',
                        'items' => ['Pertemuan Jamaah Haji Al Azhar 2018-2025', 'Program Literasi "Al Azhar Menulis"', 'Fundraising "Gelar Sorban" untuk Palestina', 'Penganugerahan Al Azhar Award']
                    ]
                ];
                @endphp
                    ...
                    <div class="p-8">
                        <ul class="space-y-3">
                            ...
                            <li class="flex items-start">
                                <svg class="w-6 h-6 text-[#0053C5] mr-3 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div x-data="{ activeDay: 1 }" class="max-w-5xl mx-auto">
                <div class="flex flex-wrap justify-center gap-4 mb-12">
                    ...
                    <button @click="activeDay = {{ $tab['id'] }}" 
                            :class="activeDay === {{ $tab['id'] }} ? 'bg-[#0053C5] text-white' : 'bg-white text-gray-700 hover:bg-gray-50 border-2 border-gray-200'"
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border-2 border-gray-100">
                    ...
                    $jadwal = [
                        1 => [
                            ['waktu' => '08.00 - 09.00', 'judul' => 'Opening Ceremony', 'desc' => 'Pembukaan resmi Al Azhar Expo 2025'],
                            ['waktu' => '08.00 - 17.00', 'judul' => 'Pameran & Bazar (All Day)', 'desc' => 'Stand pameran karya, bazar produk'],
                            ['waktu' => '10.00 - 12.00', 'judul' => 'Talkshow: Pendidikan & Adab', 'desc' => 'Diskusi tentang pendidikan karakter'],
                            ['waktu' => '14.00 - 16.00', 'judul' => 'Islamic Fashion Show', 'desc' => 'Peragaan busana muslim modern']
                        ],
                        2 => [
                            ['waktu' => '08.00 - 12.00', 'judul' => 'Lomba Robotik & Coding', 'desc' => 'Kompetisi robotik dan coding'],
                            ['waktu' => '13.00 - 15.00', 'judul' => 'Talkshow: Ekonomi Keumatan', 'desc' => 'Pemberdayaan ekonomi umat'],
                            ['waktu' => '15.30 - 17.30', 'judul' => '🌟 Talkshow Special', 'desc' => 'Anies Baswedan & Ustadz Adi Hidayat', 'special' => true],
                            ['waktu' => '19.00 - 21.00', 'judul' => 'Fundraising "Gelar Sorban"', 'desc' => 'Penggalangan dana untuk Palestina']
                        ],
                        3 => [
                            ['waktu' => '08.00 - 12.00', 'judul' => 'Digital Expo & Technology', 'desc' => 'Pameran teknologi pendidikan'],
                            ['waktu' => '13.00 - 14.00', 'judul' => 'Rampak Gendang', 'desc' => 'Pertunjukan seni tradisional'],
                            ['waktu' => '14.00 - 16.00', 'judul' => 'Pertemuan Jamaah Haji', 'desc' => 'Gathering jamaah haji 2018-2025'],
                            ['waktu' => '16.00 - 17.00', 'judul' => 'Al Azhar Award', 'desc' => 'Penghargaan tokoh Al Azhar'],
                            ['waktu' => '17.00 - 18.00', 'judul' => 'Closing Ceremony', 'desc' => 'Penutupan resmi & foto bersama']
                        ]
                    ];
                    @endphp
                    ...
                    <div x-show="activeDay === {{ $day }}" x-transition class="space-y-6">
                        ...
                        <div class="border-l-4 border-[#0053C5] pl-6 py-4 {{ isset($item['special']) ? 'bg-[#0053C5]/5' : 'hover:bg-gray-50' }} rounded-r-lg transition-all">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-2 gap-2">
                                <h4 class="text-xl font-bold {{ isset($item['special']) ? 'text-[#0053C5]' : 'text-gray-800' }}">{{ $item['judul'] }}</h4>
                                <span class="text-[#0053C5] font-semibold text-sm md:text-base whitespace-nowrap">{{ $item['waktu'] }}</span>
                            </div>
    ...
    <section id="galeri" class="py-24 bg-gray-50">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-16 reveal">
                <div class="inline-block bg-[#0053C5]/10 text-[#0053C5] px-4 py-2 rounded-full mb-4 font-semibold text-sm">DOKUMENTASI</div>
                <h2 class="text-4xl lg:text-6xl font-black text-gray-900 mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @for($i = 1; $i <= 6; $i++)
                <div class="card-hover bg-white rounded-3xl overflow-hidden shadow-lg reveal group">
                    <div class="relative overflow-hidden">
                        <img src="{{ asset('assets/img/gal' . $i . '.jpg') }}" alt="Galeri {{ $i }}" class="w-full h-72 object-cover transition-transform duration-500 group-hover:scale-110 rounded-3xl">
                        <div class="absolute inset-0 bg-gradient-to-t from-[#0053C5]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                            <p class="text-white text-lg font-semibold">Momen {{ $i }}</p>
                        </div>
                    </div>
                </div>
                @endfor
    ...
    <!-- Registration -->
    <section id="registrasi" class="py-24 bg-white">
        <div class="max-w-4xl mx-auto px-6" x-data="registrationForm()">
            <div class="text-center mb-16 reveal">
                <div class="inline-block bg-[#0053C5]/10 text-[#0053C5] px-4 py-2 rounded-full mb-4 font-semibold text-sm">PENDAFTARAN</div>
                <h2 class="text-4xl lg:text-6xl font-black text-gray-900 mb-4">
            ...
            <div x-show="success" x-cloak class="mb-8 bg-gradient-to-r from-green-500 to-green-600 text-white p-8 rounded-3xl shadow-2xl">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="space-y-2 text-sm">
                            <p class="font-bold text-lg mb-2">📋 Cara Absensi di Hari H:</p>
                            <ol class="list-decimal list-inside space-y-2 ml-2">
                                <li><strong>Buka:</strong> <span class="underline">alazharexpo.com/check-in</span></li>
                                <li><strong>Masukkan</strong> ID Peserta Anda (4 karakter di atas)</li>
                                <li><strong>Scan QR Code</strong> yang muncul di tablet absensi</li>
                                <li><strong>Selesai!</strong> Anda sudah terabsen 🎊</li>
                            </ol>
                        </div>
                        
                        <p class="text-xs opacity-75 mt-4">
                            💡 Tips: Screenshot halaman ini atau catat ID Anda
                        </p>
                    </div>
                </div>
            </div>

            <form @submit.prevent="submitForm" class="gradient-border p-10 reveal">
                <div class="space-y-6 relative z-10">
                    ...
                    <div>
                        ...
                        <p x-show="errors.{{ $field }}" x-text="errors.{{ $field }}" class="text-red-500 text-sm mt-2 font-semibold"></p>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div class="flex items-center gap-4">
                    <div class="w-20 h-20 bg-white rounded-2xl flex items-center justify-center shadow-2xl">
                        <img src="{{ asset('assets/img/logohitam.png') }}" alt="Logo" class="h-14 w-auto object-contain">
                    </div>
                    <div>
                ...
                <div class="text-center md:text-right text-sm space-y-2">
                    ...
                    <p class="opacity-80">Al Azhar Expo Menginspirasi Indonesia</p>
                </div>
            </div>
        </div>
    </footer>
